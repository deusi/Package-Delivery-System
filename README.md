...
This project implements a package delivery simulation. Amazon, FedEx, UPS, and other delivery services companies are developing automated delivery systems using drones, robots, and self-driving trucks. Current version of the project allows for a drone/robot to pick up multiple packages and deliver it to the customers. It also accounts for movement constrains caused by buildings and accounts for battery drain caused by robot/drone movement.
...
5. Open up Chrome/Firefox and browse to http://127.0.0.1:8081/
